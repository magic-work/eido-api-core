...
from app.routers.user import entities_user
from app.routers.admin import entities_admin
...
# User routes
app.include_router(entities_user.router)

# Admin routes
app.include_router(entities_admin.router)
